...
app.MapMethods("/upload/{**subpath}", ["HEAD"], handlers.UploadStatus);
...
app.MapMethods("/upload-area/upload/{**subpath}", ["HEAD"], handlers.UploadAreaStatus);
...
app.MapMethods("/my-uploads/upload/{**subpath}", ["HEAD"], handlers.MyUploadsStatus);
